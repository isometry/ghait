...
//
//	import _ "github.com/isometry/ghait/v91/provider/aws"
//	import _ "github.com/isometry/ghait/v91/provider/gcp"
//	import _ "github.com/isometry/ghait/v91/provider/vault"
//
...
import (
	...
	"github.com/isometry/ghait/v91/provider"
)
...
func NewGHAIT(ctx context.Context, cfg Config, opts ...Option) (*ghait, error) {
	...
	clientOpts := []github.ClientOptionsFunc{github.WithHTTPClient(rateLimitWaiterClient)}
	if o.baseURL != nil || o.uploadURL != nil {
		clientOpts = append(clientOpts, github.WithURLs(o.baseURL, o.uploadURL))
	}
